...
https://arc-lp-wizard.lovable.app/

## What it tests

_Tie it back to the validation brief: which assumption does this prototype put in front of a user?_

That we could have an easy to use landing page creator that would start the development process. Since there isn't much on the page in the way of content or images so they web team shouldn't really need to get involved in the development process.

## Context injected (no placeholders)

- **Real user quotes on screen:** I spend an extraordinary amount of time that I don't have managing a process that can be easily automated. Giving marketing managers three fixed wireframe options helps them plan up front. They choose one, get the content, and then can create a prototype that they can shop around for approvals. They handoff approved content to me, and I can then automate uploading and publishing into the CMS from this output.
- **Domain metrics on screen:** 8 hours of web team time managing less than 300 words of content.

## Iteration log (v1 → v3)

| Version | Change | Why |
|---|---|---|
| v1 | Refined wireframes | 2 of 3 didn't  look suitable |
| v2 | Added character counts in visual editor | Easier to see and system will enforce character counts in copy |
| v3 | Added button to export final text to copy doc for approval and validated legal | We have to get all copy approved by legal, so want a way to get updated copy back to copy doc easily. |
